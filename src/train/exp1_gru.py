"""
Train a GRU model on experiment 1 data (1_nca_* or 1_nn_*) using Optuna.
Same search as train_gru.py, but pointed at the new experiment-1 datasets.
"""
...
df.to_csv(OUT_DIR / f"optuna_gru_{prefix}_results_{run_id}.csv", index=False)
print(f"Saved trial results to {OUT_DIR}/optuna_gru_{prefix}_results_{run_id}.csv")
